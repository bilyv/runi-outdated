      ...
      <div className="p-6">
        ...
        <div className="bg-white dark:bg-dark-card rounded-lg border border-gray-200 dark:border-dark-border p-8 text-center">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-dark-text mb-2">No Transactions Found</h3>
            <p className="text-gray-600 dark:text-gray-400">
              There are no transactions recorded yet. Transactions will appear here once created.
            </p>
          </div>
        </div>
      </div>
